...
public class RutaLlegada {
    ...
    public Vector<RutaLlegada> cargarParadas() {
        Vector<RutaLlegada> objVector = new Vector<RutaLlegada>();
        RutaLlegada datos = null;

        datos = new RutaLlegada();
        datos.setId(0);
        datos.setDescrip("Seleccione ciudad de Destino : (*)");
