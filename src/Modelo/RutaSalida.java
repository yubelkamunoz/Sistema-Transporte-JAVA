...
public class RutaSalida {
    ...
    public Vector<RutaSalida> cargarParadas() {
        Vector<RutaSalida> objVector = new Vector<RutaSalida>();
        RutaSalida datos = null;

        datos = new RutaSalida();
        datos.setId(0);
        datos.setDescrip("Seleccione ciudad de Origen : (*)");
